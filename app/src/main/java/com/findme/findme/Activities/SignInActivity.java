...
public class SignInActivity extends BaseActivity implements View.OnClickListener {
    ...
    private static final String GOOGLE_CLIENT_ID = "1074686400161-aqb5t0apq4d3s17b43nilke9f7f3tiaq.apps.googleusercontent.com";
    private FirebaseAuth mAuth;
    private GoogleSignInClient mGoogleSignInClient;

    private Button google,facebookLogin;
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            Log.w(TAG, "signInWithCredential:failure", task.getException());
                            //View parentLayout = findViewById(android.R.id.content);
                            Snackbar.make(findViewById(android.R.id.content), "Authentication " +
                                            "Failed.",
                                    Snackbar.LENGTH_SHORT).show();
                            updateUI(null);
                        }
